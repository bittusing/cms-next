      ...
      {selectedImage && (
        ...
        >
          ...
          {project.images.length > 1 && (
            <div className="absolute left-6 top-1/2 -translate-y-1/2 flex flex-col space-y-3 z-[100000]">
          ...
          {project.images.length > 1 && currentImageIndex > 0 && (
            <button
              ...
              className="absolute left-20 top-1/2 -translate-y-1/2 w-14 h-14 bg-white bg-opacity-20 hover:bg-opacity-30 rounded-full flex items-center justify-center text-white text-2xl hover:text-accent transition z-[100000] backdrop-blur-sm"
          ...
          {project.images.length > 1 && currentImageIndex < project.images.length - 1 && (
            <button
              ...
              className="absolute right-4 top-1/2 -translate-y-1/2 w-14 h-14 bg-white bg-opacity-20 hover:bg-opacity-30 rounded-full flex items-center justify-center text-white text-2xl hover:text-accent transition z-[100000] backdrop-blur-sm"
          ...
          <div
            className="relative w-full h-full max-w-7xl max-h-[95vh] z-[99999]"
          ...
          {/* Image Counter */}
          {project.images.length > 1 && (
            <div className="absolute bottom-6 left-1/2 -translate-x-1/2 text-white bg-black bg-opacity-60 px-6 py-3 rounded-full text-lg font-medium z-[100000]">
              {currentImageIndex + 1} / {project.images.length}
            </div>
          )}

          {/* Project Info */}
          <div className="absolute bottom-6 right-6 text-white bg-black bg-opacity-60 px-6 py-3 rounded-lg z-[100000]">
            <p className="text-sm text-accent font-medium">{project.category.name}</p>
